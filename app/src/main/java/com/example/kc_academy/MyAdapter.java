...
public class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public MyAdapter(NotesActivity notesActivity, ArrayList<DownModel> downModels) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(notesActivity.getBaseContext());
